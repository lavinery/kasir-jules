...
CREATE TABLE "members" (
    ...
    "phone" TEXT,
    "address" TEXT,
    "discountRate" DECIMAL NOT NULL DEFAULT 0.05,
    "totalPurchase" DECIMAL NOT NULL DEFAULT 0,
...
CREATE TABLE "sales" (
    ...
    "memberDiscount" DECIMAL NOT NULL DEFAULT 0,
    "transactionDiscount" DECIMAL NOT NULL DEFAULT 0,
